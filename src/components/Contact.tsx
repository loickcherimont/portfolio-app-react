export default function Contact() {
    const links = [
        ...
        // { href: "https://www.linkedin.com/in/loickcherimont", svgContent:"M12.51 8.796v1.697a3.738 3.738 0 0 1 3.288-1.684c3.455 0 4.202 2.16 4.202 4.97V19.5h-3.2v-5.072c0-1.21-.244-2.766-2.128-2.766-1.827 0-2.139 1.317-2.139 2.676V19.5h-3.19V8.796h3.168ZM7.2 6.106a1.61 1.61 0 0 1-.988 1.483 1.595 1.595 0 0 1-1.743-.348A1.607 1.607 0 0 1 5.6 4.5a1.601 1.601 0 0 1 1.6 1.606Z", paragraphContent: "linkedin.com/in/loickcherimont" },
    ...
    return <div id="contact" className="min-h-full my-10 flex flex-col items-center">
        ...
        <main className="flex flex-col justify-around md:flex-row md:items-baseline mt-20 p-10 space-y-5 md:space-x-30 bg-black/50 rounded-lg">
            {/* SOCIALS */}
            <div className="flex flex-col items-center lg:w-1/2 lg:h-1/2">
                <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Socials</h3>
                <ul className="flex flex-col items-center gap-y-5 mt-5">

                    {/* Github, Gmail */}
                    {links.map((link, index) => (
                        <li className=" text-black bg-violet-700 rounded-lg hover:bg-violet-600 hover:-translate-y-1 transition duration-300" key={index}>
                            <a href={link.href} className="flex space-x-2 w-80 p-3" >
                                <div>                        <svg className="w-6 h-6 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* LinkedIn  */}
                    <li className=" text-black bg-violet-700 rounded-lg hover:bg-violet-600 hover:-translate-y-1 transition duration-300">
                        <a href="https://www.linkedin.com/in/loickcherimont" className="flex space-x-2 w-80 p-3">
                            <div>
                                <svg className=" text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col items-center lg:w-1/2 lg:h-1/2">
                ...
                <address className="leading-7 [&:not(:first-child)]:mt-6 not-italic text-lg flex flex-col gap-y-10 items-center">
                    <p className="text-violet-700">Nantes 44000, FRANCE</p>
                    <p className="flex bg-violet-700 p-3 rounded-lg text-black">
                        ...
                        <a href="tel:+33770261920">07.70.26.19.20</a></p>
                </address>
            </div>
        </main>
    </div>
